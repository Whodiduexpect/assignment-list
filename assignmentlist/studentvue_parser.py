...
def set_credentials():
    assignmentlist.create_if_not_exist('studentvue_credentials')
    ...
    file = assignmentlist.open_data('studentvue_credentials', 'w')
...
def get_assignments(credentials):
    ...
    try:
        ...
        click.echo(
            'Invalid credentials. You might want to use:\n   python assignmentlist.py reset')
        sys.exit()

    # Create CSV file if it doesn't exist
    assignmentlist.create_if_not_exist('studentvue_assignments.csv')
    try:
    ...
    assignmentlist.update_csv(assignments)
    return assignments
...
if __name__ == '__main__':
    click.echo("Don't run me! Run assignmentlist.py instead.")
